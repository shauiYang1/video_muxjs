...
BM.Draw.Feature = BM.Handler.extend({
  initialize: function(t, e) {
      ...
      e && e.shapeOptions && (e.shapeOptions = BM.Util.extend({}, this.options.shapeOptions, e.shapeOptions)),
      BM.setOptions(this, e);
      var i = BM.version.split(".");
      1 === parseInt(i[0], 10) && 2 <= parseInt(i[1], 10) ? BM.Draw.Feature.include(BM.Evented.prototype) : BM.Draw.Feature.include(BM.Mixin.Events)
  },
  enable: function() {
      this._enabled || (BM.Handler.prototype.enable.call(this),
      this.fire("enabled", {
          handler: this.type
      }),
  ...
  disable: function() {
      this._enabled && (BM.Handler.prototype.disable.call(this),
  ...
  addHooks: function() {
      var t = this._map;
      t && (BM.DomUtil.disableTextSelection(),
  ...
  removeHooks: function() {
      this._map && (BM.DomUtil.enableTextSelection(),
...
BM.Draw.Polyline = BM.Draw.Feature.extend({
  ...
  addHooks: function() {
      ...
      this._map.on("mouseup", this._upEvent, this).on("mousemove", this._onMouseMove, this).on("zoomlevelschange", this._onZoomEnd, this).on("dragstart", this._dragStart, this).on("zoomend", this._onZoomEnd, this),
      this._map.getContainer()._bindTouch || (this._map.getContainer()._bindTouch = !0,
  ...
  _upEvent: function(t) {
      if (!BM.Draw._clickHandled && (BM.Draw._clickHandled = !0,
      setTimeout(function() {
      ...
      this._clickHandle)) {
          if (this._drag)
              return this._drag = !1;
          var e, i = t.originalEvent || t.changedTouches[0], o = i.clientX, n = i.clientY;
          this._disableNewMarkers(),
          this._startPoint.call(this, o, n),
          t.latlng || (e = this._map.mouseEventToLayerPoint(i),
          t.latlng = this._map.layerPointToLatLng(e)),
          this._endPoint.call(this, o, n, t),
          this._tttt || (this._tttt = {
              x: 0,
              y: 0
          }),
          5 < Math.abs(this._tttt.x - o) && 5 < Math.abs(this._tttt.y - n) && this._updateTooltip(t.latlng),
          this._tttt = {
              x: o,
              y: n
          },
  ...
  removeHooks: function() {
      ...
      this._clearGuides(),
      this._map.off("mouseup", this._upEvent, this).off("mousemove", this._onMouseMove, this).off("zoomlevelschange", this._onZoomEnd, this).off("dragstart", this._dragStart, this).off("zoomend", this._onZoomEnd, this)
  },
  ...
  _endPoint: function(t, e, i) {
      var o, n;
      this._mouseDownOrigin && (o = BM.point(t, e).distanceTo(this._mouseDownOrigin),
      ...
      this._finishShape()) : n < 10 && BM.Browser.touch ? this._finishShape() : Math.abs(o) < 9 * (window.devicePixelRatio || 1) && this.addVertex(i.latlng),
  ...
  _calculateFinishDistance: function(t) {
      ...
      if (0 < this._markers.length) {
          if (this.type === BM.Draw.Polyline.TYPE)
              ...
              if (this.type !== BM.Draw.Polygon.TYPE)
                  return 1 / 0;
              e = this._markers[this._markers.length - 1]
          }
  ...
  _drawGuide: function(t, e) {
      var i, o, n, a = Math.floor(Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2))), s = this.options.guidelineDistance, r = this.options.maxGuideLineLength, h = r < a ? a - r : s;
      for (this._guidesContainer || (this._guidesContainer = BM.DomUtil.create("div", "bigemap-draw-guides", this._overlayPane)); h < a; h += this.options.guidelineDistance)
          i = h / a,
          o = {
              x: Math.floor(t.x * (1 - i) + i * e.x),
              y: Math.floor(t.y * (1 - i) + i * e.y)
          },
          (n = BM.DomUtil.create("div", "bigemap-draw-guide-dash", this._guidesContainer)).style.backgroundColor = this._errorShown ? this.options.drawError.color : this.options.shapeOptions.color,
  ...
  _getTooltipText: function() {
      var t, e = this.options.showLength, i = 0 === this._markers.length ? {
  ...
  _updateRunningMeasure: function(t, e) {
      ...
      o = BM.GeometryUtil.isVersion07x() ? t.distanceTo(this._markers[i].getLatLng()) * (this.options.factor || 1) : this._map.distance(t, this._markers[i].getLatLng()) * (this.options.factor || 1),
      this._measurementRunningTotal += o * (e ? 1 : -1))
  },
  _getMeasurementString: function() {
      var t = this._currentLatLng
        , e = this._markers[this._markers.length - 1].getLatLng()
        , i = BM.GeometryUtil.isVersion07x() ? e && t && t.distanceTo ? this._measurementRunningTotal + t.distanceTo(e) * (this.options.factor || 1) : this._measurementRunningTotal || 0 : e && t ? this._measurementRunningTotal + this._map.distance(t, e) * (this.options.factor || 1) : this._measurementRunningTotal || 0;
      return BM.GeometryUtil.readableDistance(i, this.options.metric, this.options.feet, this.options.nautic, this.options.precision)
  },
  _showErrorTooltip: function() {
      ...
      this._clearHideErrorTimeout(),
      this._hideErrorTimeout = setTimeout(BM.Util.bind(this._hideErrorTooltip, this), this.options.drawError.timeout)
  },
...
BM.Draw.Polygon = BM.Draw.Polyline.extend({
  ...
  _getTooltipText: function() {
      var t, e;
      if (this._markers)
          return 0 === this._markers.length ? t = BM.drawLocal.draw.handlers.polygon.tooltip.start : e = (t = this._markers.length < 3 ? BM.drawLocal.draw.handlers.polygon.tooltip.cont : BM.drawLocal.draw.handlers.polygon.tooltip.end,
  ...
  _getMeasurementString: function() {
      var t = this._area
        , e = "";
      return t || this.options.showLength ? (this.options.showLength && (e = BM.Draw.Polyline.prototype._getMeasurementString.call(this)),
      t && (e += "<br>" + BM.GeometryUtil.readableArea(t, this.options.metric, this.options.precision)),
      e) : null
  },
  _shapeIsValid: function() {
  ...
  _vertexChanged: function(t, e) {
      ...
      this._area = BM.GeometryUtil.geodesicArea(i)),
...
BM.Draw.SimpleShape = BM.Draw.Feature.extend({
  ...
  _onMouseDown: function(t) {
      ...
      BM.DomEvent.on(document, "mouseup", this._onMouseUp, this).on(document, "touchend", this._onMouseUp, this).preventDefault(t.originalEvent)
  },
  _onMouseMove: function(t) {
      var e = t.latlng;
...
BM.Draw.Rectangle = BM.Draw.SimpleShape.extend({
  ...
  _onMouseUp: function(t) {
      this._shape || this._isCurrentlyTwoClickDrawing ? this._isCurrentlyTwoClickDrawing && !_hasAncestor(t.target, "bigemap-pane") || BM.Draw.SimpleShape.prototype._onMouseUp.call(this) : this._isCurrentlyTwoClickDrawing = !0
  },
  _drawShape: function(t) {
      this._shape ? this._shape.setBounds(new BM.LatLngBounds(this._startLatLng,t)) : (this._shape = new BM.Rectangle(new BM.LatLngBounds(this._startLatLng,t),this.options.shapeOptions),
  ...
  _getTooltipText: function() {
      var t, e, i, o = BM.Draw.SimpleShape.prototype._getTooltipText.call(this), n = this._shape, a = this.options.showArea;
...
BM.Draw.Circle = BM.Draw.SimpleShape.extend({
  ...
  _drawShape: function(t) {
      var e;
      e = BM.GeometryUtil.isVersion07x() ? this._startLatLng.distanceTo(t) : this._map.distance(this._startLatLng, t),
      this._shape ? this._shape.setRadius(e) : (this._shape = new BM.Circle(this._startLatLng,e,this.options.shapeOptions),
      this._map.addLayer(this._shape))
  },
  _fireCreatedEvent: function() {
      var t = new BM.Circle(this._startLatLng,this._shape.getRadius(),this.options.shapeOptions);
      BM.Draw.SimpleShape.prototype._fireCreatedEvent.call(this, t)
  },
  _onMouseMove: function(t) {
      var e, i, o = t.latlng, n = this.options.showRadius, a = this.options.metric;
      this._tooltip.updatePosition(o),
      this._isDrawing && (this._drawShape(o),
      e = this._shape.getRadius().toFixed(1),
      i = "",
      n && (i = BM.drawLocal.draw.handlers.circle.radius + ": " + BM.GeometryUtil.readableDistance(e, a, this.options.feet, this.options.nautic)),
      this._tooltip.updateContent({
          text: this._endLabelText,
          subtext: i
      }))
...
BM.Edit.Poly = BM.Handler.extend({
  ...
  _defaultShape: function() {
      return !BM.Polyline._flat || BM.Polyline._flat(this._poly._latlngs) ? this._poly._latlngs : this._poly._latlngs[0]
  },
  ...
  _initHandlers: function() {
      ...
      for (var t = 0; t < this.latlngs.length; t++)
          this._verticesHandlers.push(new BM.Edit.PolyVerticesEdit(this._poly,this.latlngs[t],this._poly.options.poly))
  },
...
BM.Edit.PolyVerticesEdit = BM.Handler.extend({
  ...
  _defaultShape: function() {
      return !BM.Polyline._flat || BM.Polyline._flat(this._latlngs) ? this._latlngs : this._latlngs[0]
  },
  addHooks: function() {
      var t = this._poly
        , e = t._path;
      t instanceof BM.Polygon || (t.options.fill = !1,
  ...
  _initMarkers: function() {
      ...
      for (a = 0,
      t = s - 1; a < s; t = a++)
          (0 !== a || BM.Polygon && this._poly instanceof BM.Polygon) && (i = this._markers[t],
          o = this._markers[a],
  ...
  _onMarkerDrag: function(t) {
      var e, i, o = t.target, n = this._poly, a = BM.LatLngUtil.cloneLatLng(o._origLatLng);
      BM.extend(o._origLatLng, o._latlng),
      n.options.poly && (e = n._map._editTooltip,
      !n.options.poly.allowIntersection && n.intersects() && (BM.extend(o._origLatLng, a),
      o.setLatLng(a),
      i = n.options.color,
      n.setStyle({
          color: this.options.drawError.color
  ...
  _createMiddleMarker: function(e, i) {
      var o, n, t, a = this._getMiddleLatLng(e, i), s = this._createMarker(a);
      s.setOpacity(.6),
      ...
      ,
      s.on("click", o, this).on("dragstart", n, this).on("dragend", t, this).on("touchmove", n, this),
...
BM.Polyline.addInitHook(function() {
  this.editing || (BM.Edit.Poly && (this.editing = new BM.Edit.Poly(this),
...
BM.Edit.SimpleShape = BM.Handler.extend({
  ...
  initialize: function(t, e) {
      BM.Browser.touch && (this.options.moveIcon = this.options.touchMoveIcon,
...
BM.Edit.Rectangle = BM.Edit.SimpleShape.extend({
  ...
  _move: function(t) {
      for (var e, i = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(), o = this._shape.getBounds().getCenter(), n = [], a = 0, s = i.length; a < s; a++)
          e = [i[a].lat - o.lat, i[a].lng - o.lng],
...
BM.Rectangle.addInitHook(function() {
  BM.Edit.Rectangle && (this.editing = new BM.Edit.Rectangle(this),
  this.options.editable && this.editing.enable())
}),
BM.Edit = BM.Edit || {},
BM.Edit.Marker = BM.Handler.extend({
  ...
  _toggleMarkerHighlight: function() {
      ...
      BM.DomUtil.hasClass(t, "leaflet-edit-marker-selected") ? (BM.DomUtil.removeClass(t, "leaflet-edit-marker-selected"),
      this._offsetMarker(t, -4)) : (BM.DomUtil.addClass(t, "leaflet-edit-marker-selected"),
...
BM.Marker.addInitHook(function() {
  BM.Edit.Marker && (this.editing = new BM.Edit.Marker(this),
  this.options.editable && this.editing.enable())
}),
BM.Edit = BM.Edit || {},
...
BM.CircleMarker.addInitHook(function() {
  BM.Edit.CircleMarker && (this.editing = new BM.Edit.CircleMarker(this),
  this.options.editable && this.editing.enable()),
  this.on("add", function() {
      this.editing && this.editing.enabled() && this.editing.addHooks()
  }),
...
BM.Edit.Circle = BM.Edit.CircleMarker.extend({
  ...
  _resize: function(t) {
      ...
      this._map.editTooltip && this._map._editTooltip.updateContent({
          ...
          subtext: BM.drawLocal.draw.handlers.circle.radius + ": " + BM.GeometryUtil.readableDistance(radius, !0, this.options.feet, this.options.nautic)
      }),
      this._shape.setRadius(radius),
      this._map.fire(BM.Draw.Event.EDITRESIZE, {
          layer: this._shape
...
BM.Circle.addInitHook(function() {
  BM.Edit.Circle && (this.editing = new BM.Edit.Circle(this),
  this.options.editable && this.editing.enable())
}),
BM.Map.mergeOptions({
  touchExtend: !0
...
BM.Map.TouchExtend = BM.Handler.extend({
  ...
  addHooks: function() {
      ...
      this._detectIE() ? (BM.DomEvent.on(this._container, "MSPointerDown", this._onTouchStart, this),
      ...
      BM.DomEvent.on(this._container, "MSPointerCancel", this._onTouchCancel, this)) : (BM.DomEvent.on(this._container, "touchcancel", this._onTouchCancel, this),
  ...
  removeHooks: function() {
      ...
      this._detectIE() ? (BM.DomEvent.off(this._container, "MSPointerDown", this._onTouchStart, this),
      ...
      BM.DomEvent.off(this._container, "MSPointerCancel", this._onTouchCancel, this)) : (BM.DomEvent.off(this._container, "touchcancel", this._onTouchCancel, this),
  ...
  _filterClick: function(t) {
      ...
      return i && 100 < i && i < 500 || t.target._simulatedClick && !t._simulated ? (BM.DomEvent.stop(t),
      !1) : (BM.DomEvent._lastClick = e,
      !0)
  },
  _onTouchStart: function(t) {
...
BM.Marker.Touch = BM.Marker.extend({
  _initInteraction: function() {
      return this.addInteractiveTarget ? BM.Marker.prototype._initInteraction.apply(this) : this._initInteractionLegacy()
  },
  _initInteractionLegacy: function() {
      if (this.options.clickable) {
          ...
          BM.Handler.MarkerDrag && (this.dragging = new BM.Handler.MarkerDrag(this),
...
BM.LatLngUtil = {
  cloneLatLngs: function(t) {
      for (var e = [], i = 0, o = t.length; i < o; i++)
          Array.isArray(t[i]) ? e.push(BM.LatLngUtil.cloneLatLngs(t[i])) : e.push(this.cloneLatLng(t[i]));
      return e
  },
  ...
  BM.GeometryUtil = BM.extend(BM.GeometryUtil || {}, {
      geodesicArea: function(t) {
          ...
          if (2 < o) {
              for (var s = 0; s < o; s++)
                  e = t[s],
                  n += ((i = t[(s + 1) % o]).lng - e.lng) * a * (2 + Math.sin(e.lat * a) + Math.sin(i.lat * a));
              n = 6378137 * n * 6378137 / 2
          }
          return Math.abs(n)
      },
      formattedNumber: function(t, e) {
          var i, o = parseFloat(t).toFixed(e), n = BM.drawLocal.format && BM.drawLocal.format.numeric, a = n && n.delimiters, s = a && a.thousands, r = a && a.decimal;
          return (s || r) && (i = o.split("."),
      ...
      readableArea: function(t, e, i) {
          var o, i = BM.Util.extend({}, r, i), n = e ? (o = ["ha", "m"],
          type = typeof e,
          "string" === type ? o = [e] : "boolean" !== type && (o = e),
          1e6 <= t && -1 !== o.indexOf("km") ? BM.GeometryUtil.formattedNumber(1e-6 * t, i.km) + " km²" : 1e4 <= t && -1 !== o.indexOf("ha") ? BM.GeometryUtil.formattedNumber(1e-4 * t, i.ha) + " ha" : BM.GeometryUtil.formattedNumber(t, i.m) + " m²") : 3097600 <= (t /= .836127) ? BM.GeometryUtil.formattedNumber(t / 3097600, i.mi) + " mi²" : 4840 <= t ? BM.GeometryUtil.formattedNumber(t / 4840, i.ac) + " acres" : BM.GeometryUtil.formattedNumber(t, i.yd) + " yd²";
          return n
      },
      readableDistance: function(t, e, i, o, n) {
          var a, n = BM.Util.extend({}, r, n), s = e ? "string" == typeof e ? e : "metric" : i ? "feet" : o ? "nauticalMile" : "yards";
          switch (s) {
          case "metric":
              a = 1e3 < t ? BM.GeometryUtil.formattedNumber(t / 1e3, n.km) + " km" : BM.GeometryUtil.formattedNumber(t, n.m) + " m";
              break;
          case "feet":
              t *= 3.28083,
              a = BM.GeometryUtil.formattedNumber(t, n.ft) + " ft";
              break;
          case "nauticalMile":
              t *= .53996,
              a = BM.GeometryUtil.formattedNumber(t / 1e3, n.nm) + " nm";
              break;
          case "yards":
          default:
              a = 1760 < (t *= 1.09361) ? BM.GeometryUtil.formattedNumber(t / 1760, n.mi) + " miles" : BM.GeometryUtil.formattedNumber(t, n.yd) + " yd"
          }
          return a
      },
...
BM.Polyline.include({
  ...
  _lineSegmentsIntersectsRange: function(t, e, i, o) {
      ...
      for (var r = i; o < r; r--)
          if (n = s[r - 1],
          a = s[r],
          BM.LineUtil.segmentsIntersect(t, e, n, a))
              return !0;
      return !1
  },
...
BM.Polygon.include({
  intersects: function() {
      ...
      return !this._tooFewPointsForIntersection() && (!!BM.Polyline.prototype.intersects.call(this) || (t = n.length,
      e = n[0],
      i = n[t - 1],
      o = t - 2,
...
BM.Control.Draw = BM.Control.extend({
  ...
  initialize: function(t) {
      ...
      this._toolbars = {},
      BM.DrawToolbar && this.options.draw && (e = new BM.DrawToolbar(this.options.draw),
      this._toolbars[BM.DrawToolbar.TYPE] = e,
      this._toolbars[BM.DrawToolbar.TYPE].on("enable", this._toolbarEnabled, this)),
      BM.EditToolbar && this.options.edit && (e = new BM.EditToolbar(this.options.edit),
      this._toolbars[BM.EditToolbar.TYPE] = e,
      this._toolbars[BM.EditToolbar.TYPE].on("enable", this._toolbarEnabled, this)),
      BM.toolbar = this
  },
  onAdd: function(t) {
      var e, i, o = BM.DomUtil.create("div", "bigemap-draw"), n = !1, a = "bigemap-draw-toolbar-top";
      for (i in this._toolbars)
          this._toolbars.hasOwnProperty(i) && (e = this._toolbars[i].addToolbar(t)) && (n || (BM.DomUtil.hasClass(e, a) || BM.DomUtil.addClass(e.childNodes[0], a),
          n = !0),
          o.appendChild(e));
      return o
  },
...
BM.Map.addInitHook(function() {
  this.options.drawControl && (this.drawControl = new BM.Control.Draw,
...
BM.Draw.Tooltip = BM.Class.extend({
  initialize: function(t) {
      ...
      this._popupPane = t._panes.popupPane,
      this._visible = !1,
      this._container = t.options.drawControlTooltips ? BM.DomUtil.create("div", "bigemap-draw-tooltip", this._popupPane) : null,
  ...
  updateContent: function(t) {
      ...
      0 !== t.subtext.length || this._singleLineLabel ? 0 < t.subtext.length && this._singleLineLabel && (BM.DomUtil.removeClass(this._container, "bigemap-draw-tooltip-single"),
      this._singleLineLabel = !1) : (BM.DomUtil.addClass(this._container, "bigemap-draw-tooltip-single"),
      this._singleLineLabel = !0),
      this._container.innerHTML = (0 < t.subtext.length ? '<span class="bigemap-draw-tooltip-subtext">' + t.subtext + "</span><br />" : "") + "<span>" + t.text + "</span>",
  ...
  updatePosition: function(t) {
      ...
      BM.DomUtil.setPosition(i, e)),
      this
  },
  showAsError: function() {
      return this._container && BM.DomUtil.addClass(this._container, "bigemap-error-draw-tooltip"),
      this
  },
  removeError: function() {
      return this._container && BM.DomUtil.removeClass(this._container, "bigemap-error-draw-tooltip"),
      this
  },
  _onMouseOut: function() {
...
BM.Toolbar = BM.Class.extend({
  initialize: function(t) {
      ...
      1 === parseInt(e[0], 10) && 2 <= parseInt(e[1], 10) ? BM.Toolbar.include(BM.Evented.prototype) : BM.Toolbar.include(BM.Mixin.Events)
  },
  enabled: function() {
  ...
  addToolbar: function(t) {
      var e, i = BM.DomUtil.create("div", "bigemap-draw-section"), o = 0, n = this._toolbarClass || "", a = this.getModeHandlers(t);
      for (this._toolbarContainer = BM.DomUtil.create("div", "bigemap-draw-toolbar bigemap-bar"),
      this._map = t,
      e = 0; e < a.length; e++)
  ...
  _createButton: function(t) {
      ...
      return BM.DomEvent.on(e, "click", BM.DomEvent.stopPropagation).on(e, "mousedown", BM.DomEvent.stopPropagation).on(e, "dblclick", BM.DomEvent.stopPropagation).on(e, "touchstart", BM.DomEvent.stopPropagation).on(e, "click", BM.DomEvent.preventDefault).on(e, o, t.callback, t.context),
      e
  },
  _disposeButton: function(t, e) {
      var i = this._detectIOS() ? "touchstart" : "click";
      BM.DomEvent.off(t, "click", BM.DomEvent.stopPropagation).off(t, "mousedown", BM.DomEvent.stopPropagation).off(t, "dblclick", BM.DomEvent.stopPropagation).off(t, "touchstart", BM.DomEvent.stopPropagation).off(t, "click", BM.DomEvent.preventDefault).off(t, i, e)
  },
  ...
  _createActions: function(t) {
      for (var e, i, o = this._actionsContainer, n = this.getActions(t), a = n.length, s = 0, r = this._actionButtons.length; s < r; s++)
          this._disposeButton(this._actionButtons[s].button, this._actionButtons[s].callback);
      for (this._actionButtons = []; o.firstChild; )
          o.removeChild(o.firstChild);
      for (var h = 0; h < a; h++)
          "enabled"in n[h] && !n[h].enabled || (e = BM.DomUtil.create("li", "", o),
  ...
  _showActionsToolbar: function() {
      ...
      0 === t && (BM.DomUtil.addClass(this._toolbarContainer, "bigemap-draw-toolbar-notop"),
      BM.DomUtil.addClass(this._actionsContainer, "bigemap-draw-actions-top")),
      t === e && (BM.DomUtil.addClass(this._toolbarContainer, "bigemap-draw-toolbar-nobottom"),
...
BM.DrawToolbar = BM.Toolbar.extend({
  ...
  setOptions: function(t) {
      for (var e in BM.setOptions(this, t),
      this._modes)
...
BM.EditToolbar = BM.Toolbar.extend({
  ...
  initialize: function(t) {
      ...
      t.edit.selectedPathOptions = BM.extend({}, this.options.edit.selectedPathOptions, t.edit.selectedPathOptions)),
  ...
  _checkDisabled: function() {
      ...
      this.options.edit && (t = this._modes[BM.EditToolbar.Edit.TYPE].button,
      e ? BM.DomUtil.removeClass(t, "bigemap-disabled") : BM.DomUtil.addClass(t, "bigemap-disabled"),
      t.setAttribute("title", e ? BM.drawLocal.edit.toolbar.buttons.edit : BM.drawLocal.edit.toolbar.buttons.editDisabled)),
      this.options.remove && (t = this._modes[BM.EditToolbar.Delete.TYPE].button,
      e ? BM.DomUtil.removeClass(t, "bigemap-disabled") : BM.DomUtil.addClass(t, "bigemap-disabled"),
      t.setAttribute("title", e ? BM.drawLocal.edit.toolbar.buttons.remove : BM.drawLocal.edit.toolbar.buttons.removeDisabled))
  }
}),
BM.EditToolbar.Edit = BM.Handler.extend({
  ...
  initialize: function(t, e) {
      if (BM.Handler.prototype.initialize.call(this, t),
      BM.setOptions(this, e),
      ...
      var i = BM.version.split(".");
      1 === parseInt(i[0], 10) && 2 <= parseInt(i[1], 10) ? BM.EditToolbar.Edit.include(BM.Evented.prototype) : BM.EditToolbar.Edit.include(BM.Mixin.Events)
  },
  enable: function() {
  ...
  addHooks: function() {
      ...
      this._updateTooltip(),
      this._map.on("mousemove", this._onMouseMove, this).on("touchmove", this._onMouseMove, this).on("MSPointerMove", this._onMouseMove, this).on(BM.Draw.Event.EDITVERTEX, this._updateTooltip, this))
  },
  removeHooks: function() {
      ...
      this._tooltip.dispose(),
      this._tooltip = null,
      this._map.off("mousemove", this._onMouseMove, this).off("touchmove", this._onMouseMove, this).off("MSPointerMove", this._onMouseMove, this).off(BM.Draw.Event.EDITVERTEX, this._updateTooltip, this))
  },
  ...
  _backupLayer: function(t) {
      ...
      this._uneditedLayerProps[e] || (t instanceof BM.Polyline || t instanceof BM.Polygon || t instanceof BM.Rectangle ? this._uneditedLayerProps[e] = {
          latlngs: BM.LatLngUtil.cloneLatLngs(t.getLatLngs())
      } : t instanceof BM.Circle ? this._uneditedLayerProps[e] = {
          latlng: BM.LatLngUtil.cloneLatLng(t.getLatLng()),
          radius: t.getRadius()
      } : (t instanceof BM.Marker || t instanceof BM.CircleMarker) && (this._uneditedLayerProps[e] = {
          latlng: BM.LatLngUtil.cloneLatLng(t.getLatLng())
      }))
  },
  _getTooltipText: function() {
  ...
  _revertLayer: function(t) {
      var e = BM.Util.stamp(t);
      t.edited = !1,
      this._uneditedLayerProps.hasOwnProperty(e) && (t instanceof BM.Polyline || t instanceof BM.Polygon || t instanceof BM.Rectangle ? t.setLatLngs(this._uneditedLayerProps[e].latlngs) : t instanceof BM.Circle ? (t.setLatLng(this._uneditedLayerProps[e].latlng),
      t.setRadius(this._uneditedLayerProps[e].radius)) : (t instanceof BM.Marker || t instanceof BM.CircleMarker) && t.setLatLng(this._uneditedLayerProps[e].latlng),
  ...
  _enableLayerEdit: function(t) {
      ...
      this._backupLayer(o),
      this.options.poly && (i = BM.Util.extend({}, this.options.poly),
      o.options.poly = i),
      this.options.selectedPathOptions && ((e = BM.Util.extend({}, this.options.selectedPathOptions)).maintainColor && (e.color = o.options.color,
      e.fillColor = o.options.fillColor),
      o.options.original = BM.extend({}, o.options),
      o.options.editing = e),
      o instanceof BM.Marker ? (o.editing && o.editing.enable(),
      o.dragging.enable(),
  ...
  _disableLayerEdit: function(t) {
      ...
      this._selectedPathOptions && (e instanceof BM.Marker ? this._toggleMarkerHighlight(e) : (e.setStyle(e.options.previousOptions),
      delete e.options.previousOptions)),
      e instanceof BM.Marker ? (e.dragging.disable(),
...
BM.EditToolbar.Delete = BM.Handler.extend({
  ...
  initialize: function(t, e) {
      ...
      var i = BM.version.split(".");
      1 === parseInt(i[0], 10) && 2 <= parseInt(i[1], 10) ? BM.EditToolbar.Delete.include(BM.Evented.prototype) : BM.EditToolbar.Delete.include(BM.Mixin.Events)
  },
  enable: function() {
      !this._enabled && this._hasAvailableLayers() && (this.fire("enabled", {
          handler: this.type
